package com.example.socialmediaapi.errorhandling;
import com.example.socialmediaapi.exception.ApiException;
...
public class AppErrorAttributes extends DefaultErrorAttributes {
    ...
    public Map<String, Object> getErrorAttributes(ServerRequest request, ErrorAttributeOptions options) {
        ...
        if (error instanceof CustomAuthorizationException || error instanceof UnauthorizedException
